...
const roleIcons = {
  ...
  intern: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      <path d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.499 5.221 50.554 50.554 0 00-2.658.813m-15.482 0a50.557 50.557 0 018.445-2.957m0 0a48.627 48.627 0 00-5.912 5.554m5.912-5.554a2.25 2.25 0 104.5 0 2.25 2.25 0 00-4.5 0zM12 13.902a48.627 48.627 0 008.232-4.41M12 13.902a48.627 48.627 0 01-8.232-4.41M12 13.902c1.657 0 3.18-.287 4.5-.803m-15.482 0a50.617 50.617 0 008.445-2.957" />
    </svg>
  ),
  manager: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">

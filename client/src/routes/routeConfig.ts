...
export const appRoutes: RouteDefinition[] = [
  ...
  {
    path: '/dashboard/admin/notifications-email',
    component: DashboardPage,
    isProtected: true,
    allowedRoles: ['admin'],
  },
  { path: '/dashboard/admin/archive', component: DashboardPage, isProtected: true, allowedRoles: ['admin'] },
  { path: '/dashboard/admin/bi-access', component: DashboardPage, isProtected: true, allowedRoles: ['admin'] },

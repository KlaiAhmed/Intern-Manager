...
namespace InternManager.Api.Data.Migrations
{
    ...
    [Migration("20260526180646_AddDeliverableVersionSubmissionMetadata")]
    partial class AddDeliverableVersionSubmissionMetadata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InternManager.Api.Models.Entities.DeliverableVersion", b =>
                {
                    ...
                    b.ToTable("DeliverableVersions", null, t =>
                        {
                            t.HasCheckConstraint("CK_DeliverableVersions_SubmissionSource", "(([FileUrl] IS NOT NULL AND [GitHubUrl] IS NULL) OR ([FileUrl] IS NULL AND [GitHubUrl] IS NOT NULL))");
                        });
                });
